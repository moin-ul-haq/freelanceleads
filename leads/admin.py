...
class LeadAdmin(admin.ModelAdmin):
    list_display  = ('name', 'niche', 'city', 'state', 'country', 'opportunity_score', 'audit_done', 'created_at')
...
class SearchCacheAdmin(admin.ModelAdmin):
    list_display  = ('cache_key', 'niche', 'city', 'state', 'total_results', 'is_exhausted', 'last_fetched')
